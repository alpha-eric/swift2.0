//
//  RestuarantPictureTableViewController.swift
//  FoodPicture
//
...
class RestuarantPictureTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath) as! RestuarantPictureTableViewCell
        cell.nameLabel?.text = restaurantNames[indexPath.row]
        cell.locationLabel?.text = "Taiwan"
        cell.imageView?.image = UIImage(named: "B\(indexPath.row%3)")
        return cell
    }
